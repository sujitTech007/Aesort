...
$pageTitle = $pageTitle ?? 'Terms and Conditions – Aesort';

$currentPage = $currentPage ?? 'terms.conditions';
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="page-header-box">
                    ...
                    <h1 class="text-anime">Terms and Conditions</h1>
...
<p class="mb-2">By using the Services, you confirm that:</p>

<ul class="ms-4">

    <li>You are at least 18 years old;</li>

    <li>You have the authority to enter into a contract on behalf of your organization;</li>

    <li>Your use of the Services complies with all applicable laws in your jurisdiction.</li>
...
<ul class="ms-4">
    ...
    <li>Copy, reverse engineer, or modify any part of the platform;</li>

    <li>Attempt to access source code or proprietary algorithms.</li>
...
<p>Aesort may integrate with third-party systems such as building management systems (BMS), energy monitoring tools, or utilities. Aesort is not responsible for the reliability, performance, or security of third-party services.</p>
...
<p>These Terms are governed by the laws of Ontario, Canada. Any disputes shall be resolved exclusively in the courts of Ontario.</p>
