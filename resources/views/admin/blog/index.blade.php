...
<div class="page-content">
    ...
    <div class="page-title-head d-flex align-items-center gap-2">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-bold mb-0 py-2">Blog</h4>
        </div>
                                ...
                                <div class="col-sm-12 col-md-12 d-flex justify-content-end">
                                    <div class="gridjs-head">
                                        <div class="gridjs-search d-flex align-items-center gap-1">
                                             <form action="{{ route('admin.blog.index') }}" method="GET" class="d-flex align-items-center gap-1">
    <input 
        type="search" 
        name="keyword" 
    ...
    <button type="submit" class="btn btn-primary">
      ...
      <a href="{{ route('admin.blog.index') }}" class="btn btn-secondary gap-1 ">
        <i class="ri-refresh-line"> </i> Reset
    </a>
</form>
                                            <a href="{{ route('admin.blog.create') }}" class="btn btn-sm btn-primary d-flex gap-1 createBtn">
                                    ...
                                    <table id="deviceTable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>
                                                  <img src="{{ asset('uploads/blog-images/' . $blog->image) }}" alt="" style="width: 100px; height: 70px; object-fit: cover; border-radius: 5px;">  
                                                </td>
                                                <td>{{ @$blog->title }}</td>
