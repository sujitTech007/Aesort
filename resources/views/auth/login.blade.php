@php
	...
	$pageTitle = $pageTitle ?? 'Login – Aesort';
...
<div class="col-lg-6">
	...
	<div class="contact-form-box">
		...
		<div class="section-title">
			...
			<h2 class="text-anime wow fadeInUp">LogIn</h2>
		...
		<div class="contact-form wow">
			...
			<form id="loginForm" action="{{ route('login.perform') }}" method="POST" data-toggle="validator">
				...
				<div class="row">
					...
					<select id="login_phone_code" name="phone_code" data-show-subtext="false" data-live-search="true" class="selectpicker">
					...
					<div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('login.google') }}" class="btn btn-light w-100" 
       style="border:1px solid #ddd; padding:10px; border-radius:5px; display:flex; align-items:center; justify-content:center; gap:10px;">
